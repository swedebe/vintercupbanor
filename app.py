...
def index():
    if request.method == "POST":
        try:
            ...
            if meos_xml and meos_xml.filename:
    ...
    <h1>Ladda upp MeOS-XML eller klistra in banor A–E</h1>
    <form method=post enctype=multipart/form-data>
      MeOS XML: <input type=file name=meos_xml><br><br>
      <i>Alternativt: fyll i banor + varvningskontroll och ladda upp IOF-resultat XML.</i><br><br>
